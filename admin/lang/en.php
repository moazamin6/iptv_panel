...
$_ = Array(
    ...
    "dashboard_no_permissions" => "Welcome to Smart UI! You do not have permission to view the dashboard.",
	...
	"permission_settings_text" => "Edit general, video, mag, security & Smart UI settings.",
