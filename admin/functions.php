...
function getFooter()
{
    ...
    if ($rPermissions["is_admin"]) {
        if ($rEarlyAccess) {
            return $_["copyright"] . " &copy; " . date("Y") . " - <a href=\"https://iptv.moazamin6.com\" target='_blank'>Smart UI</a> R" . $rRelease . $rEarlyAccess . " - " . $_["early_access"];
        } else {
            return $_["copyright"] . " &copy; " . date("Y") . " - <a href=\"https://iptv.moazamin6.com\" target='_blank'>Smart UI</a> R" . $rRelease . " - " . $_["free_forever"];
        }
    } else {
